...
variable "subnet_id" {
  description = "ID of the private subnet where the Redis EC2 instance will be launched."
  type        = string
}

variable "instance_profile_name" {
  description = "Name of the IAM instance profile to attach to the Redis EC2 instance."
  type        = string
}
...
variable "instance_type" {
  description = "EC2 instance type for Redis. Use t3.small for MVP."
  type        = string
  default     = "t3.small"
}
